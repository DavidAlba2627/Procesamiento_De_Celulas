...
%Im1_C_Filt = Im1_C;
figure();imshow(Im1_C_Filt); title('Imagen de las celulas suavizadas','Fontsize',15);
% Realizando el umbral global
otsu = Im1_C_Filt < 0.25;
...
Im_Seg = Im1_C_Filt > T;
Im1_C = Im_Seg.*Im1_C;
figure();imshow(Im1_C); title('Segmentacion de celulas','Fontsize',15);
