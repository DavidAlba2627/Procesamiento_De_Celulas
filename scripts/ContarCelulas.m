function [] = ContarCelulas(Archivo,verbose)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Creando la carpeta que contendra las tablas con las estadisticas
    cd ..; cd Tablas_de_estadisticas;
    if ~exist(Archivo, 'dir')
        mkdir(Archivo);
    end

%Creando las tablas dentro de esa carpeta
cd (Archivo);
writetable(Conteo_general, strcat('Conteo_general_',Archivo,'.csv'));
writetable(Tabla_Regiones, strcat('Tabla_Regiones_',Archivo,'.csv'));
writetable(Tabla_Propiedades_Marcaje_1, strcat('Tabla_Propiedades_Marcaje_1_',Archivo,'.csv'));
writetable(Tabla_Propiedades_Marcaje_2, strcat('Tabla_Propiedades_Marcaje_2_',Archivo,'.csv'));
writetable(Tabla_Propiedades_Marcaje_3, strcat('Tabla_Propiedades_Marcaje_3_',Archivo,'.csv'));
writetable(Expresion_canal1_canal2, strcat('Expresion_canal1_canal2_',Archivo,'.csv'));
writetable(Expresion_canal1_canal3, strcat('Expresion_canal1_canal3_',Archivo,'.csv'));
writetable(Expresion_canal2_canal3, strcat('Expresion_canal2_canal3_',Archivo,'.csv'));
