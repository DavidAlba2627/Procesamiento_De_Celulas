...
cd ..; cd cell_images;
Im1 = im2double(imread('25x-NeuN-Hoechst-dx-15 ZEN.tif'));
cd ..; cd scripts;
...
area_condicion = 600;
Condiciones = [stats1.Area] < area_condicion/3 | [stats1.Area] > area_condicion*2 | [stats1.Circularity] < 0.3;
...
Condiciones_Crecidas = [stats4.Area] < 600/3 | [stats4.Area] > area_condicion*2 | [stats4.Circularity] < 0.3;
