...
% Alba Bonilla David Angel
% Cardenas Aguilar Uriel
% Lara Arellano Edgar
close all;
clear variables;
clc;
...
cd ..; cd cell_images;
Im1 = im2double(imread('63x-NeuN-Hoechst-izq-18 ZEN.tif'));
cd ..; cd scripts;
...
Condiciones = [stats1.Area] < 2200/2 | [stats1.Area] > 2200*2 | [stats1.Circularity] < 0.3;
...
% Separando nucleos
Condiciones_Separacion = [stats2.MajorAxisLength./stats2.MinorAxisLength] > 1.5 & [stats2.Area] > 2200*1.5;
...
Condiciones_Crecidas = [stats4.Area] < 2200/2 | [stats4.Area] > 2200*2 | [stats4.Circularity] < 0.3;
...
figure();subplot(1,3,1);imshow(Im1);title('Imagen original','Fontsize',15);
subplot(1,3,2);imshow(Im1_C);title('Celulas enumeradas','Fontsize',15);
hold on;
for k=1:n5
    [r,c] = find(L5==k);
    rbar = mean(r);
...
hold off;
subplot(1,3,3);imshow(Im_rgb);title("Positivos y Negativos",'Fontsize',15);
